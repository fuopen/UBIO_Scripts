...
#-----------------------------------------------------
$output = 'adult_skin_prick_3subjects_consolidated.csv'; # Set output file
open (OUT, ">$output"); #|| die print "\n\Could not write to the output file.$!\n"; # Open the output file


#READ IN FIRST FILE AND CREATE HASH
#-----------------------------------------------------
$input_file = '/Users/ip304/Documents/UBIOPRED/UBIOPRED_data/Adult_Data/New_Baseline_Data_to_be_included_Nov_2014_release/2014-11-24-adult-processed/Processed/2014-11-24-adult_skin_prick_3subjects.txt'; #First list
